...
public class SceneTransformer implements ViewPager.PageTransformer {
    ...
    public interface TutorialSceneChangeListener {
    ...
    private List<TutorialSceneChangeListener> mSceneChangeListeners = new ArrayList<>();
    ...
    public void addSceneChangeListener(@NonNull TutorialSceneChangeListener sceneChangeListener) {
        mSceneChangeListeners.add(sceneChangeListener);
    }

    private void makeSceneCallbacks(@NonNull TutorialSceneChangeListener sceneChangeListener,
                                    float position) {
