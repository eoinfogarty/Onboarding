package redstar.onboarding.onboarding;
...
import redstar.onboarding.onboarding.databinding.ActivityMainBinding;
import redstar.onboarding.onboarding.adapter.ScenePagerAdapter;
import redstar.onboarding.onboarding.adapter.TextPagerAdapter;
        ...
        if (savedInstanceState != null) {
            ...
            for (Fragment fragment : getSupportFragmentManager().getFragments()) {
                sceneTransformer.addSceneChangeListener(
                        (SceneTransformer.TutorialSceneChangeListener) fragment);
            }
        }
    }
